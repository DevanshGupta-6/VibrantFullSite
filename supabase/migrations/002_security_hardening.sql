...
using (private.has_permission('events.view') and deleted_at is null);

create policy "admin events insert"
on public.events for insert to authenticated
with check (private.has_permission('events.create'));

create policy "admin events update"
on public.events for update to authenticated
using (private.has_permission('events.edit') and deleted_at is null)
with check (private.has_permission('events.edit'));

create policy "admin events delete"
on public.events for delete to authenticated
using (private.has_permission('events.delete') and deleted_at is null);

drop policy if exists "admin sponsors select" on public.sponsors;
drop policy if exists "admin sponsors insert" on public.sponsors;
drop policy if exists "admin sponsors update" on public.sponsors;
drop policy if exists "admin sponsors delete" on public.sponsors;

create policy "admin sponsors select"
on public.sponsors for select to authenticated
using (private.has_permission('sponsors.view') and deleted_at is null);

create policy "admin sponsors insert"
on public.sponsors for insert to authenticated
with check (private.has_permission('sponsors.create'));

create policy "admin sponsors update"
on public.sponsors for update to authenticated
using (private.has_permission('sponsors.edit') and deleted_at is null)
with check (private.has_permission('sponsors.edit'));

create policy "admin sponsors delete"
on public.sponsors for delete to authenticated
using (private.has_permission('sponsors.delete') and deleted_at is null);

drop policy if exists "admin gallery select" on public.gallery_photos;
drop policy if exists "admin gallery insert" on public.gallery_photos;
drop policy if exists "admin gallery update" on public.gallery_photos;
drop policy if exists "admin gallery delete" on public.gallery_photos;

create policy "admin gallery select"
on public.gallery_photos for select to authenticated
using (private.has_permission('gallery.view') and deleted_at is null);

create policy "admin gallery insert"
on public.gallery_photos for insert to authenticated
with check (private.has_permission('gallery.create'));

create policy "admin gallery update"
on public.gallery_photos for update to authenticated
using (private.has_permission('gallery.edit') and deleted_at is null)
with check (private.has_permission('gallery.edit'));

create policy "admin gallery delete"
on public.gallery_photos for delete to authenticated
using (private.has_permission('gallery.delete') and deleted_at is null);

drop policy if exists "admin faqs select" on public.faqs;
drop policy if exists "admin faqs insert" on public.faqs;
...
using (private.has_permission('faqs.view') and deleted_at is null);

create policy "admin faqs insert"
on public.faqs for insert to authenticated
with check (private.has_permission('faqs.create'));

create policy "admin faqs update"
on public.faqs for update to authenticated
using (private.has_permission('faqs.edit') and deleted_at is null)
with check (private.has_permission('faqs.edit'));

create policy "admin faqs delete"
on public.faqs for delete to authenticated
using (private.has_permission('faqs.delete') and deleted_at is null);

drop policy if exists "admin schedule select" on public.schedule_items;
drop policy if exists "admin schedule insert" on public.schedule_items;
drop policy if exists "admin schedule update" on public.schedule_items;
drop policy if exists "admin schedule delete" on public.schedule_items;

create policy "admin schedule select"
on public.schedule_items for select to authenticated
using (private.has_permission('schedule.view'));

create policy "admin schedule insert"
on public.schedule_items for insert to authenticated
with check (private.has_permission('schedule.create'));

create policy "admin schedule update"
on public.schedule_items for update to authenticated
using (private.has_permission('schedule.edit'))
with check (private.has_permission('schedule.edit'));

create policy "admin schedule delete"
on public.schedule_items for delete to authenticated
using (private.has_permission('schedule.delete'));

drop policy if exists "admin settings select" on public.site_settings;
drop policy if exists "admin settings update" on public.site_settings;

create policy "admin settings select"
on public.site_settings for select to authenticated
using (private.has_permission('settings.view'));
...
drop policy if exists "admin roles select" on public.roles;
drop policy if exists "admin roles insert" on public.roles;
drop policy if exists "admin roles update" on public.roles;
drop policy if exists "admin roles delete" on public.roles;
...
with check (private.has_permission('roles.create'));

create policy "admin roles update"
on public.roles for update to authenticated
using (private.has_permission('roles.edit'))
with check (private.has_permission('roles.edit'));

create policy "admin roles delete"
on public.roles for delete to authenticated
using (private.has_permission('roles.delete'));

drop policy if exists "admin role_permissions select" on public.role_permissions;
drop policy if exists "admin role_permissions insert" on public.role_permissions;
drop policy if exists "admin role_permissions update" on public.role_permissions;
drop policy if exists "admin role_permissions delete" on public.role_permissions;
...
drop policy if exists "admin permissions select" on public.permissions;
...
using (
  ...
  or id in (
    ...
    where au.id = auth.uid() and au.deleted_at is null
  )
);
...
drop policy if exists "admin users delete" on public.admin_users;

create policy "admin users select"
on public.admin_users for select to authenticated
using (
  id = auth.uid()
  or (private.has_permission('users.view') and deleted_at is null)
);

create policy "admin users insert"
on public.admin_users for insert to authenticated
with check (private.has_permission('users.create'));

create policy "admin users update"
on public.admin_users for update to authenticated
using (private.has_permission('users.edit') and deleted_at is null)
with check (private.has_permission('users.edit'));

create policy "admin users delete"
on public.admin_users for delete to authenticated
using (private.has_permission('users.delete'));

drop policy if exists "admin audit select" on public.audit_logs;
