...
export default async function AdminDashboard() {
  ...
  const stats = [
    { title:"Total Users", value:String(statsData.adminCount), icon:Users, href:"/admin/users" },
    { title:"Active Events", value:String(statsData.eventCount), icon:Calendar, href:"/admin/events" },
    { title:"Gallery Items", value:String(statsData.galleryPhotoCount), icon:ImageIcon, href:"/admin/gallery" },
    { title:"Sponsors", value:String(statsData.sponsorCount), icon:Briefcase, href:"/admin/sponsors" },
  ];
